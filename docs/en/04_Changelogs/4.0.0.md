...
* Minimum version dependencies have increased; PHP 5.6 and Internet Explorer 10 (or other modern browser)
  is required.
...
* The authentication login/logout has been rewritten to a clearer API and supports easier hooks and extending.
