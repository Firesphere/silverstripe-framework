...
class SilverStripeBackend {
   ...
   *   method: 'post',
   *   payloadSchema: {
   *    one: { urlReplacement: ':one', replace: true },
   ...
   * If using it alongside `replace: true`, the original key will be removed from the data payload.
   *
   * **querystring**
   *
